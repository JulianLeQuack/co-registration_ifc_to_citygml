...
tol = 0.1  # matching tolerance on vertical axis
best_match = None
best_inliers = 0
...
for ifc_feat in ifc_features_filtered:
    ...
    for city_feat in citygml_features_filtered:
        ...
        for feat_ifc2 in ifc_features_filtered:
            ...
            # count as inlier if any city feature matches this shifted y within tol
            if any(abs(city_feat2[3] - y2_shifted) <= tol for city_feat2 in citygml_features_filtered):
                inliers += 1
